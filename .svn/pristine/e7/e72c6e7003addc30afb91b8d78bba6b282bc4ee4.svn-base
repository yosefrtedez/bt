object Frm_PembelianOrder: TFrm_PembelianOrder
  Left = 236
  Top = 139
  Align = alClient
  BorderStyle = bsNone
  ...
  object RzGroupBox1: TRzGroupBox
    ...
    object RzPanel1: TRzPanel
      ...
      object txtrequest: TRzButtonEdit
        Left = 473
        Top = 21
        Width = 136
        Height = 23
        ...
        TabOnEnter = True
        TabOrder = 2
        OnKeyPress = txtrequestKeyPress
        AllowKeyEdit = False
        OnButtonClick = txtrequestButtonClick
      end
  ...
  object QMataUang: TZQuery
    Connection = DM.con
    SQL.Strings = (
      'select * from tbl_matauang')
    Params = <>
    Left = 1000
    Top = 24
  end
