object Frm_Penjualan: TFrm_Penjualan
  Left = 97
  Top = 41
  Align = alClient
  BorderStyle = bsNone
  ...
  object RzGroupBox1: TRzGroupBox
    ...
    object RzPanel1: TRzPanel
      ...
      object LNoPenjualanKirim: TRzLabel
        Left = 619
        Top = 27
        Width = 106
        Height = 15
        Alignment = taRightJustify
        Caption = 'LNoPenjualanKirim'
        Font.Charset = ANSI_CHARSET
        Font.Color = clBlack
        Font.Height = -13
        Font.Name = 'Calibri'
      ...
      object txtsj: TRzButtonEdit
        ...
        TabOnEnter = True
        TabOrder = 3
        OnKeyPress = txtsjKeyPress
        AllowKeyEdit = False
        OnButtonClick = txtsjButtonClick
      end
    end
    object RzPanel2: TRzPanel
      ...
      object BtnPengiriman: TRzBitBtn
        Left = 16
        Top = 8
        Caption = 'pengiriman'
        TabOrder = 2
    ...
    object RzPanel3: TRzPanel
      ...
      object dbgbarang: TNextGrid6
        ...
        object NxNumberColumn61: TNxNumberColumn6
          ...
          Footer.Font.Style = []
          Footer.FormatMask = '#,##0.00'
          Header.Caption = 'noakunpajakpenjualanblm'
          Header.Font.Charset = DEFAULT_CHARSET
          Header.Font.Color = clWindowText
          Header.Font.Height = -11
          Header.Font.Name = 'MS Sans Serif'
