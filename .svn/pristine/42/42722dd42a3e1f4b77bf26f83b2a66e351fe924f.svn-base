object Frm_PenjualanPengiriman: TFrm_PenjualanPengiriman
  Left = 267
  Top = 107
  Align = alClient
  BorderStyle = bsNone
  Caption = 'Pengiriman Barang (Trucking)'
  ClientHeight = 614
  ClientWidth = 1067
  Color = clBtnFace
  ...
  object RzGroupBox1: TRzGroupBox
    ...
    object RzPanel1: TRzPanel
      ...
      object txtgudang: TRzButtonEdit
        ...
        TabOnEnter = True
        TabOrder = 4
        OnKeyPress = txtgudangKeyPress
        AllowKeyEdit = False
        OnButtonClick = txtgudangButtonClick
      end
      object txtso: TRzButtonEdit
        Left = 521
        Top = 21
        Width = 208
        Height = 23
        ...
        TabOnEnter = True
        TabOrder = 3
        OnKeyPress = txtsoKeyPress
        AllowKeyEdit = False
        OnButtonClick = txtsoButtonClick
      end
    ...
    object RzPanel3: TRzPanel
      ...
      object dbgbarang: TNextGrid6
        ...
        object NxNumberColumn622: TNxNumberColumn6
          ...
          Footer.Font.Style = []
          Footer.FormatMask = '#,##0.00'
          Header.Caption = 'piutangblmtertagih'
          Header.Font.Charset = DEFAULT_CHARSET
          Header.Font.Color = clWindowText
          Header.Font.Height = -11
          Header.Font.Name = 'MS Sans Serif'
